...
import { projectName } from 'vs/project.patch'
...
export const ipcRenderer: IpcRenderer = globals[projectName].ipcRenderer;
export const ipcMessagePort: IpcMessagePort = globals[projectName].ipcMessagePort;
export const webFrame: WebFrame = globals[projectName].webFrame;
export const process: ISandboxNodeProcess = globals[projectName].process;
export const context: ISandboxContext = globals[projectName].context;
